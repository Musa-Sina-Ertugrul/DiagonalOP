...
from diagonal import diagonal_div
...
class TestAdd(unittest.TestCase):
    ...
    def test_div_diagonal(self):
        ...
        identity_matrix = torch.eye(5, dtype=torch.float32, device="cuda").add(1)
    ...
    def test_ddp(self):
        ...
        error_code = subprocess.call(["python", "./test/div_diagonal/_ddp.py"])
        if error_code:
