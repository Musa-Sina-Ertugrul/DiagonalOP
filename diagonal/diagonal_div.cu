...
#include "diagonal_div.h"

CREATE_DIAGONAL_OP_INNER(div_diagonal_kernel,//shemem step
    T* local_input = input;
...
CREATE_DIAGONAL_OP_INNER(div_diagonal_array_kernel, //shmem 2 x step
    T* local_input = input;
    T* local_value = values;
